...
void main() {
  //frag_color = vec4(0,0,texture2D(character_texture,vertex_data.texture_coordinate).a,1);
  ...
  frag_color.a = texture2D(character_texture,vertex_data.texture_coordinate).a;
